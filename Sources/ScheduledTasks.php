...
{
	global $settings, $modSettings, $smcFunc, $mbname, $context, $boarddir, $sourcedir;
	...
	foreach ($settings as $key => &$value) {
		if (!preg_match("/^actual/", $key) && preg_match("/theme_dir$/", $key)) {
			$value = preg_replace("/^.*\/Themes/", "{$boarddir}/Themes", $value);
