...
{
	global $modSettings, $smcFunc, $boarddir;
	...
	// Hack - change db to fix
	$path = preg_replace("/^.*boards\.sethroberts\.net\/attachments/", "{$boarddir}/attachments", $path);
...
{
	global $modSettings, $db_character_set, $boarddir;
