...
<html xmlns="http://www.w3.org/1999/xhtml"', $context['right_to_left'] ? ' dir="rtl"' : '', '><head>';
	...
	// The ?1336793727 part of this link is just here to make sure browsers don't cache it wrongly.
	echo '
	<meta http-equiv="Content-Type" content="text/html; charset=', $context['character_set'], '" />
	<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1" />
	<link rel="stylesheet" type="text/css" href="', $settings['theme_url'], '/css/index', $context['theme_variant'], '.css?1336793727" />';
	...
	echo '
	<script type="text/javascript" src="', $settings['default_theme_url'], '/scripts/script.js?1336793727"></script>
	<script type="text/javascript" src="', $settings['theme_url'], '/scripts/theme.js?1336793727"></script>
...
<script type="text/javascript">
  var _gaq = _gaq || [];
  _gaq.push(["_setAccount", "UA-2068530-1"]);
...
function template_menu()
{
	...
	echo '
	<div class="main_menu">
		<ul class="reset clearfix floatleft">';
	...
	echo '
		...
		<ul class="reset clearfix floatright">
			<li id="button_webiste">
				<a href="http://sethroberts.net/" title="sethroberts.net">
					<span>sethroberts.net</span>
				</a>
			</li>
			<li id="button_blog">
				<a href="http://blog.sethroberts.net/" title="Blog">
					<span>Blog</span>
				</a>
			</li>
			<li class="last" id="button_buy_the_book">
				<a href="http://www.amazon.com/Shangri-Diet-Hunger-Anything-Weight-Loss/dp/0399533168/ref=ed_oe_p/002-0885004-4236054" title="Buy The Book">
